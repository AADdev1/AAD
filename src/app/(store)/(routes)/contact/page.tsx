      ...
      <div className="container mx-auto p-4 space-y-6">
        ...
        <div className="bg-white/70 dark:bg-gray-900/40 rounded-xl p-4 shadow-sm border">
          ...
          <ul className="space-y-1 text-sm text-muted-foreground">
            <li>📧 Email: <a href="mailto:contact@yourstore.com" className="text-blue-600">contact@yourstore.com</a></li>
            <li>📞 Call: +91 98765 43210</li>
            <li>💬 WhatsApp: <a href="https://wa.me/919876543210" className="text-green-600">Chat with us</a></li>
